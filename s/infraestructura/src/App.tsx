...
const { get: getPresence, tick } = usePresenceSimple(API_ROOT, 10000);
...
// Mezcla presencia (ok/warn/bad) en cada nodo antes de renderizar
const nodesWithPresence = useMemo(() => {
  // Si en tu código usás "nodesWithStatus", lo tomamos como base; si no, usamos "nodes"
...
}, [nodes, (typeof nodesWithStatus !== "undefined" ? nodesWithStatus : null), getPresence, tick]);
